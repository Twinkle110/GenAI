...
def app():
    ...
    if submit_button:
        ...
        system_message_content = "You are an AI assistant tasked with generating Meeting Minutes (MOM) from the provided text, including details such as Participants,Summary,key points, action items, decisions made,conclusion  and other important details from the script and present them in a structured format suitable for distribution or reference and in different section in bullet points.Aim to retain the most important points, providing a coherent and readable summary that could help a person understand the main points of the discussion without needing to read the entire text.Please avoid unnecessary details or tangential points.I am designed to provide assistance without bias based on religion, ethnicity, or caste. I do not assess emotions. My goal is to offer respectful and impartial support.Please ensure to follow the specified sequence: 1)Participants, 2) Brief Discussion/Agenda , 3) Summary of Discussion, 4)Action Items, 5) Decisions Made 6) Meeting Conclusion"
